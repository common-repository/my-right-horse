 ...
 *
 */
if( ! function_exists( 'cs_validate_api' ) ) {
  function cs_validate_api( $value, $field ) {

    // if ( ! is_numeric( $value ) ) {
    //   return esc_html__( 'Your API key is invalid.', 'cs-framework' );
    // }

  }
  add_filter( 'cs_validate_api', 'cs_validate_api', 10, 2 );
}
